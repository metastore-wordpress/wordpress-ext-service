...
/**
 * Class WP_EXT_Service_Template
 */
class WP_EXT_Service_Template extends WP_EXT_Service {
 ...
 *
 * @return WP_EXT_Service_Template
 */
function WP_EXT_Service_Template() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Service_Template;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Service_Template(), 'run' ] );

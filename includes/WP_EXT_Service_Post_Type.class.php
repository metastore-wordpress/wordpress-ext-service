...
/**
 * Class WP_EXT_Service_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Service_Post_Type extends WP_EXT_Service {
	...
	public function post_type() {
		$labels  = [
			'name'                  => _x( 'Services', 'Service General Name', 'wp-ext-' . $this->domain_ID ),
			'singular_name'         => _x( 'Service', 'Service Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Services', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Service', 'wp-ext-' . $this->domain_ID ),
		...
		$args    = [
			'label'               => __( 'Service', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'Service Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
 ...
 *
 * @return WP_EXT_Service_Post_Type
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Service_Post_Type() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Service_Post_Type;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Service_Post_Type(), 'run' ] );

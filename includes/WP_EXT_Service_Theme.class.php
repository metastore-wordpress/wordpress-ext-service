...
/**
 * Class WP_EXT_Service_Theme
 */
class WP_EXT_Service_Theme extends WP_EXT_Service {
 ...
 *
 * @return WP_EXT_Service_Theme
 */
function WP_EXT_Service_Theme() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Service_Theme;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Service_Theme(), 'run' ] );

...
class WP_EXT_Service {
	...
	public function __construct() {
		// Settings.
		$this->pt_ID      = 'service';
		$this->archive_ID = 'services';
		$this->domain_ID  = 'service';
		$this->cap_type   = [ 'pt_service', 'pt_services' ];
 ...
 *
 * @return WP_EXT_Service
 */
function WP_EXT_Service() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Service;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Service(), 'run' ] );
